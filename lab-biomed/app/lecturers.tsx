...
const LECTURERS = [
  ...
  {
    id: 2,
    name: 'Prof. Dr. Ir. Ratna Widyawati, M.Sc.',
    title: 'Dosen Senior',
    expertise: ['Medical Image Processing', 'Telemedicine', 'Bioinformatics'],
    email: 'ratna.widyawati@stei.itb.ac.id',
    image: require('@/assets/images/Dosen/people1.jpeg'),
  },
  {
    id: 3,
    ...
    email: 'ahmad.fauzi@stei.itb.ac.id',
  ...
  },
  {
    ...
    email: 'hendra.wijaya@stei.itb.ac.id',
    image: require('@/assets/images/Dosen/people3.jpeg'),
  },
  {
    id: 5,
    name: 'Dr. Agus Setiawan, S.T., M.Sc.',
    title: 'Dosen',
    expertise: ['Biosignal Processing', 'Neural Engineering', 'Brain-Computer Interface'],
    email: 'agus.setiawan@stei.itb.ac.id',
    image: require('@/assets/images/Dosen/people4.jpeg'),
  },
  {
    id: 6,
    name: 'Dewi Lestari, S.T., M.T.',
    title: 'Dosen',
    expertise: ['Clinical Engineering', 'Medical Device Testing', 'Quality Assurance'],
    email: 'dewi.lestari@stei.itb.ac.id',
